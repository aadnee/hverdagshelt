            ...
            <Grid.Row columns={2} only="computer" className="mapRow">
              <Grid.Column width={10} className="mapRow">
                <MapWidget
                  ...
                  searchControl
                  locate
                  callbackPoint={this.callbackPoint}
                  callbackArea={this.callbackArea}
                  areaToggle={this.areaToggler}
                  submit={this.submit}
                  placedMarker={this.placedMarker}
                />
              </Grid.Column>
              <Grid.Column width={6} only="computer" className="frontPageFeed">
                ...
                {this.state.areaToggle ? (
                  <>
                    <Button
                      icon="undo"
                      disabled={!this.state.area.length > 0}
                      onClick={() => this.mapWidget.undoArea()}
                    />
                    <Button
                      icon="trash alternate"
                      disabled={!this.state.area.length > 0}
                      onClick={() => this.mapWidget.clear()}
                    />
                  </>
                ) : null}
                {!this.state.areaToggle ? (
